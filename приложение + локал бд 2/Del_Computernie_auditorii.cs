...
namespace Практика
{
    public partial class Del_Computernie_auditorii : Form
    {
        public Del_Computernie_auditorii()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dialog == DialogResult.Yes)
                {
                    ...
                    SqlCommand sqldel = new SqlCommand("DELETE FROM Computernie_auditorii WHERE caud_nom_aud=@caud_nom_aud", myConnection);
                    sqldel.Parameters.AddWithValue("caud_nom_aud", textBox1.Text);
