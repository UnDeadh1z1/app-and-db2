...
namespace Практика
{
    public partial class T_Potochnie_auditorii : Form
    {
        public T_Potochnie_auditorii()
        {
            InitializeComponent();
        ...
        private void LoadData()
        {
            ...
            //sql запрос 
            string queryselect = "SELECT*FROM Potochnie_auditorii";
        ...
        {
            Add_Potochnie_auditorii f = new Add_Potochnie_auditorii();
            this.Hide();
            f.ShowDialog();
        }
        ...
        {
            Upd_Potochnie_auditorii f = new Upd_Potochnie_auditorii();
            this.Hide();
            f.ShowDialog();
        }
        ...
        {
            Del_Potochnie_auditorii f = new Del_Potochnie_auditorii();
            this.Hide();
            f.ShowDialog();
        }
