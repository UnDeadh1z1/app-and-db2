...
namespace Практика
{
    public partial class Del_Lekcionnie_auditorii : Form
    {
        public Del_Lekcionnie_auditorii()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dialog == DialogResult.Yes)
                {
                    ...
                    SqlCommand sqldel = new SqlCommand("DELETE FROM Lekcionnie_auditorii WHERE laud_nom_aud =@laud_nom_aud ", myConnection);
                    sqldel.Parameters.AddWithValue("laud_nom_aud ", textBox1.Text);
